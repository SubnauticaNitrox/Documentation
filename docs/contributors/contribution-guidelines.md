...
- **<span class="do">DO</span> consistent function naming 📛** <br/>Normal functions should be a verb, except if it is a callback. Functions should not be in the past tense unless it's an event. Consistency when following naming conventions is paramount to understandable code.
